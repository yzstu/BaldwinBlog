...
<head>
    ...
    <link href="<%=basePath%>css/index_style.css" rel="stylesheet" type="text/css">
    <link href="<%=basePath%>css/animate.min.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<div id="navgation" class="navgation navgation_close">
    ...
    <div class="logo"><a>Mr.Baldwin</a></div>
</div>
