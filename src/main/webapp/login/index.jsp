    ...
    <div class="container h-100">
        <div class="row justify-content-md-center h-100">
            <div class="card-wrapper">
                <div class="brand">
                    <img src="<%=basePath%>image/logo.jpg" alt="logo">
                </div>
                <div class="card fat">
                    <div class="card-body">
                        <h4 class="card-title">Login</h4>
                        <form method="POST" class="my-login-validation" novalidate="" action="/user/login.action">
                            ...
                            <div class="form-group">
                                <label for="password">Password
                                    <a href="<%=basePath%>login/forgot.jsp" class="float-right">
                                        Forgot Password?
                                    </a>
                                </label>
